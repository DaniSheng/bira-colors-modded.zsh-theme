...
THEME_ZSH_FILE=https://raw.githubusercontent.com/DaniSheng/bira-colors-modded.zsh-theme/master/bira-colors-modded.zsh-theme
ZSH_CUSTOM=${ZSH_CUSTOM:-$HOME/.oh-my-zsh/custom/themes}
